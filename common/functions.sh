...
mount_mirrors() {
  $KSU && mount -o remount,rw $MAGISKTMP
...
ui_print ""
ui_print "=============================="
ui_print "    Installing wtfxetra mod   "
ui_print "=============================="
sleep 1
...
slow_step "Preparing files"
sleep 1

slow_step "Copying module files"
sleep 1

slow_step "Applying kernel tweaks"
sleep 1

slow_step "Setting properties"
sleep 1

slow_step "Remounting Partition as RW"
sleep 1
